...
function script_enqueue() {
   ...
   wp_register_script( "googlemap_script", 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAJschzOs369jwFPTI5npQl27iqyIBm3UU');
...
function css_enqueue() {
   ...
   //wp_enqueue_style( 'mutual-eventos-slick-theme-1212', get_template_directory_uri().'/assets/css/slick-theme.css','','1.0' );
	//wp_enqueue_style( 'mutual-eventos-magnific-popup-1212', get_template_directory_uri().'/assets/css/magnific-popup.css','','1.0' );
}
