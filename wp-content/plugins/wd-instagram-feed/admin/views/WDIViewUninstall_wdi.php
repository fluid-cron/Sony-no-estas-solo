...
////////////////////////////////////////////////////////////////////////////////////////
  public function display()
  {
    ...
    <p
      style="color:red;font-size:15px"> <?php _e('Deactivating Instagram Feed WD plugin does not remove any data that may have been created. To completely remove this plugin, you can uninstall it here.', 'wdi') ?>
      <br>
      <?php _e('WARNING: Once uninstalled, this can\'t be undone. You should use a Database Backup plugin of WordPress to back up all the data first.', 'wdi') ?>
    </p>
    <p
      style="color:red;margin-top:10px;font-size:13px;"> <?php _e('The following Database Tables will be deleted:', 'wdi') ?> </p>
  ...
  public function already_uninstalled()
  {
    ...
    <!--<p style="color:green;font-size:15px"> <?php /*_e('Instagram Feed WD is uninstalled','wdi') */
    ?><a style="text-decoration:none;padding:3px;" href="<?php /*echo $deactivate_url */
    ?>"> <?php /*_e('Click Here') */
    ?> </a><?php /*_e('to deactivate it','wdi') */
    ?></p>-->
    <p><strong><a href="#" class="wdi_deactivate_link"
                  data-uninstall="1"><?php _e("Click Here", "wdi"); ?></a><?php _e(" To Finish the Uninstallation and Instagram Feed WD  will be Deactivated Automatically.", "wdi"); ?>
      </strong></p>
  ...
  public function successfully_uninstalled()
  {
    ...
    <p
      style="color:green;margin-top:10px;font-size:13px;"> <?php _e('The following Database Tables has been successfully deleted:', 'wdi') ?> </p>
    <div style="background-color:white;border:1px solid #888888">
      <ul style="background-color:white;margin:0">
        <p style="background-color:#F3EFEF;margin: 0;border-bottom: 1px solid #888888;padding:2px;font-size:20px;">
          Database Tables</p>
    ...
    <!--<p style="color:green;font-size:15px"> <?php /*_e('Instagram Feed WD is successfully uninstalled','wdi') */
    ?><a style="text-decoration:none;padding:3px;" href="<?php /*echo $deactivate_url */
    ?>"> <?php /*_e('Click Here') */
    ?> </a><?php /*_e('to deactivate it','wdi') */
    ?></p>-->
